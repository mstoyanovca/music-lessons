...
class ActivityStudentDetails : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent.getParcelableExtra("STUDENT", Student::class.java) != null) {
            // coming from AdapterStudents:
            student = intent.getParcelableExtra("STUDENT", Student::class.java)!!
            updatedStudentId = 0L
        } else if (intent.getParcelableExtra("UPDATED_STUDENT", Student::class.java) != null) {
            // coming from ActivityEditStudent:
            student = intent.getParcelableExtra("UPDATED_STUDENT", Student::class.java)!!
