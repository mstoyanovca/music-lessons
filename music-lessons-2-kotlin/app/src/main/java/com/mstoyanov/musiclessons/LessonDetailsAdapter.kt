...
class LessonDetailsAdapter(private val phoneNumbers: MutableList<PhoneNumber>, private val context: Context) : RecyclerView.Adapter<LessonDetailsAdapter.ViewHolder>() {
